...
public class Convert {
	 ...
	 * @throws cn.hutool.core.convert.ConvertException 转换器不存在
	 */
	public static <T> T convert(TypeReference<T> reference, Object value) throws cn.hutool.core.convert.ConvertException {
	...
	public static <T> T convertWithCheck(Type type, Object value, T defaultValue, boolean quietly) {
		final cn.hutool.core.convert.ConverterRegistry registry = cn.hutool.core.convert.ConverterRegistry.getInstance();
		try {
	...
	public static String numberToChinese(double number, boolean isUseTraditonal) {
		return cn.hutool.core.convert.NumberChineseFormatter.format(number, isUseTraditonal);
	}
	...
	public static String digitToChinese(Number n) {
		...
		return cn.hutool.core.convert.NumberChineseFormatter.format(n.doubleValue(), true, true);
	}
